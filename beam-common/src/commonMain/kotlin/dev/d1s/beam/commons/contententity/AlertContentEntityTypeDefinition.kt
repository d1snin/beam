...
public data object AlertContentEntityTypeDefinition : CommonContentEntityTypeDefinition(name = "alert") {
...
public enum class AlertStyle(public val code: String) {
    PRIMARY("primary"),
    SECONDARY("secondary"),
    SUCCESS("success"),
    DANGER("danger"),
    ...
    public companion object {
        ...
        public val Default: AlertStyle = PRIMARY

        public fun byName(name: String): AlertStyle? =
            entries.find {
